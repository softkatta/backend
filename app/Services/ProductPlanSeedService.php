...
class ProductPlanSeedService
{
    ...
    private function seedGoldStorePlans(Product $product): void
    {
        ...
        $plans = [
            ['name' => 'Single Store', 'slug' => 'gold-store-single', 'description' => 'Jewellery billing and inventory for one store', 'price' => 2999, 'discount' => 0, 'billing_cycle' => 'monthly', 'is_popular' => true, 'sort_order' => 1, 'limits' => ['max_branches' => 1, 'max_customers' => 1000, 'max_gst_invoices' => 500, 'max_non_gst_invoices' => 500, 'invoice_limit_period' => 'monthly', 'max_devices' => 1, 'max_storage' => 10, 'enabled_modules' => $commonModules]],
            ['name' => 'Multi Store', 'slug' => 'gold-store-multi', 'description' => 'Jewellery operations for growing multi-store businesses', 'price' => 6999, 'discount' => 0, 'billing_cycle' => 'monthly', 'is_popular' => false, 'sort_order' => 2, 'limits' => ['max_branches' => 5, 'max_customers' => 5000, 'max_gst_invoices' => 2500, 'max_non_gst_invoices' => 2500, 'invoice_limit_period' => 'monthly', 'max_devices' => 5, 'max_storage' => 50, 'enabled_modules' => $commonModules]],
            ['name' => 'Single Store (Yearly)', 'slug' => 'gold-store-single-yearly', 'description' => 'Annual jewellery store licence with savings', 'price' => 35988, 'discount' => 20, 'billing_cycle' => 'yearly', 'is_popular' => false, 'sort_order' => 3, 'limits' => ['max_branches' => 1, 'max_customers' => 2000, 'max_gst_invoices' => 7500, 'max_non_gst_invoices' => 7500, 'invoice_limit_period' => 'yearly', 'max_devices' => 1, 'max_storage' => 10, 'enabled_modules' => $commonModules]],
        ];
