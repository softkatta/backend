...
class InvoiceProfileService
{
    ...
    public function branding(): array
    {
        ...
        return [
            ...
            'social_facebook' => trim((string) ($this->settings()['social_facebook'] ?? '')),
            'social_instagram' => trim((string) ($this->settings()['social_instagram'] ?? '')),
            'social_linkedin' => trim((string) ($this->settings()['social_linkedin'] ?? '')),
            'social_twitter' => trim((string) ($this->settings()['social_twitter'] ?? '')),
            'social_youtube' => trim((string) ($this->settings()['social_youtube'] ?? '')),
            'social_whatsapp' => trim((string) ($this->settings()['social_whatsapp'] ?? '')),
        ];
    }
